...
ace.define("ace/mode/bouquet_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/doc_comment_highlight_rules","ace/mode/text_highlight_rules"], function(require, exports, module) {
    "use strict";
    ...
    oop.inherits(BouquetHighlightRules, TextHighlightRules);
    ...
    exports.BouquetHighlightRules = BouquetHighlightRules;
});
...
ace.define("ace/mode/bouquet",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/bouquet_highlight_rules","ace/mode/matching_brace_outdent","ace/range","ace/worker/worker_client","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle"], function(require, exports, module) {
    "use strict";

    var oop = require("../lib/oop");
    var TextMode = require("./text").Mode;
    var BouquetHighlightRules = require("./bouquet_highlight_rules").BouquetHighlightRules;
    ...
    var Mode = function() {
        this.HighlightRules = BouquetHighlightRules;
